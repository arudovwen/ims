    ...
    _c("div", { staticClass: "box box_1" }, [
        ...
        [
          _c(
            "router-link",
            {
              ...
              attrs: { to: "/admin/directory/school" }
            },
      ...
      _c(
        ...
        [
          _c(
            "router-link",
            { staticClass: "icon-text", attrs: { to: "/admin/lga" } },
            [_vm._v("LGAs Directory")]
          )
        ],
        1
      )
      ...
      _c("div", { staticClass: "mini_box2 mini_first" }, [
        _c(
          ...
          [
            _c(
              "router-link",
              { staticClass: "icon-text", attrs: { to: "/admin/staffs" } },
