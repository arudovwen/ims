        ...
        if (res.status == 200) {
          ...
          res.data.forEach(function (item) {
            if (item.status == 'active') {
              _this.activeA.push(item);
            }

            if (item.status == 'inactive') {
              _this.sideA.push(item);
            }
          });
        }
      });
    },
    gotoNews: function gotoNews(id, title) {
      this.$router.push({
        name: "NewsBlog",
        params: {
          id: id,
  ...
  return _c("div", { staticClass: "main" }, [
    ...
    _c("div", { attrs: { id: "announcement" } }, [
      _c("div", { staticClass: "left_box" }, [
        _c("div", { staticClass: "comm_body d-flex" }, [
          _vm.activeA.length
            ? _c("div", {}, [
                _vm._m(0),
                _vm._v(" "),
                _c("h4", { staticClass: " mb-3 top_head text-center mc1" }, [
                  _vm._v(_vm._s(_vm.activeA[0].subject))
                ]),
                _vm._v(" "),
                _vm.activeA[0].cover_image
                  ? _c("div", { staticClass: "comm_image" }, [
                      _c("img", {
                        attrs: {
                          src: _vm.activeA[0].cover_image,
                          alt: "announcement"
                        }
                      })
                    ])
                ...
                _c(
                  ...
                  [
                    _c("p", {
                      ...
                      domProps: { innerHTML: _vm._s(_vm.activeA[0].content) }
                    }),
                    _vm._v(" "),
                    _vm.activeA.length
                      ? _c(
                          ...
                          [_c("small", [_vm._v("Continue reading..")])]
                        )
                      : _vm._e()
                  ],
                  1
                      ...
                      [
                        ...
                        _c(
                          "div",
                          {
                            ...
                            on: {
                              click: function($event) {
                                _vm.gotoNews(ne.id, ne.subject.toLowerCase())
                              }
                            }
                          },
                          [
                            _c("p", { staticClass: "news-info text-center" }, [
        ...
        [
          _c(
            ...
            [
              _c(
                "b-col",
                { staticClass: "mb-4", attrs: { cols: "12", sm: "4" } },
                [
                  _c(
                    "b-card",
                    {
                            ...
                            return [
                              _c(
                                ...
                                [
                                  ...
                                  _c("small", [
                                    _vm._v(
                                      "List of Schools in Imo State that are registered for WASSCE 2020"
                                    )
                                  ])
                                ]
                              )
              ...
              _c(
                "b-col",
                { staticClass: "mb-1", attrs: { cols: "12", sm: "4" } },
                [
                  _c(
                    "b-card",
                    {
                          ...
                          fn: function() {
                            return [
                              _c(
                                ...
                                [
                                  _c("strong", [_vm._v("Transfer LIST")]),
                                  _vm._v(" "),
                                  _c("br"),
                                  _vm._v(" "),
                                  _c("small", [
          ...
          _c(
            ...
            [
              _c(
                "router-link",
                { staticClass: "mc1", attrs: { to: "/directory" } },
                [_vm._v("View all")]
              )
            ],
            1
...
var render = function() {
  ...
  return _c("div", { attrs: { id: "polls" } }, [
    ...
    _c("div", { staticClass: "my-poll z" }, [
      _c(
        "div",
        { staticClass: "newsletter shadow-sm tab" },
        [
          _c("router-link", { attrs: { to: "/forms" } }, [
            ...
            _vm._v(" "),
            _c("h4", { staticClass: "josefin text-white" }, [_vm._v("Forms")])
          ])
        ],
        1
      ),
      ...
      _c(
        ...
        [
          _c("router-link", { attrs: { to: "/staffs" } }, [
            _c("div", { staticClass: "fa-stack icon" }, [
              _c("i", {
                staticClass: "fa fa-circle fa-stack-2x mc1",
                attrs: { "aria-hidden": "true" }
              ...
              _vm._v(" "),
              _c("i", {
                staticClass: "fa fa-envelope fa-stack-1x text-white",
                attrs: { "aria-hidden": "true" }
              })
            ])
          ]),
          _vm._v(" "),
          _c("router-link", { attrs: { to: "/staffs" } }, [
            _c("h4", { staticClass: "josefin text-white" }, [_vm._v("Staffs")])
          ])
        ],
        1
      ),
      ...
      _c(
        "div",
        { staticClass: "opinions shadow-sm tab" },
        [
          _c("router-link", { attrs: { to: "/schedule-appointment" } }, [
            _c("div", { staticClass: "fa-stack icon" }, [
              _c("i", {
                staticClass: "fa fa-circle fa-stack-2x mc1",
                attrs: { "aria-hidden": "true" }
              ...
              _vm._v(" "),
              _c("i", {
                staticClass: "fas fa-calendar fa-stack-1x text-white",
                attrs: { "aria-hidden": "true" }
              })
            ]),
            _vm._v(" "),
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "opinions shadow-sm tab" }, [
      ...
      _vm._v(" "),
      _c("h4", { staticClass: "josefin text-white" }, [_vm._v("Epay")])
    ])
  }
]
render._withStripped = true
