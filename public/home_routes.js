...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getAnnouncement: function getAnnouncement() {
      ...
      axios.get("/api/get-latest-announcement").then(function (res) {
        if (res.status == 200) {
      ...
      _c("div", { staticClass: "left_box" }, [
        _c("div", { staticClass: "comm_body" }, [
          ...
          _c("div", { staticClass: "comm_image" }, [
            _c("img", {
              attrs: { src: _vm.announcement.cover_image, alt: "announcement" }
            })
          ]),
          _vm._v(" "),
          _c("p", {
          ...
          ? _c(
              ...
              [
                _c("router-link", { attrs: { to: "" } }, [
                  _c("span", { staticClass: "text-dark cpointer" }, [
                    _vm._v(
                      _vm._s(
                        _vm._f("moment")(new Date(), "dddd, MMMM D YYYY")
                      ) + " :"
                    )
                  ]),
                  _vm._v(" "),
