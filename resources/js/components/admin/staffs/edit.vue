<template>
  <div class="form">
    ...
    <form @submit.prevent="create">
      <legend class="text-center">Edit Staff</legend>
...
export default {
  ...
  methods: {
    create() {
      axios
        .put(`/api/staff/${this.$route.params.id}`, this.staff, {
          headers: {
